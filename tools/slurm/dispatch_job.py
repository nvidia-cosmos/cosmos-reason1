...
def main():
    ...
    parser.add_argument("--launcher", type=str, default="cosmos_reason1.dispatcher.run_web_panel", help="Launcher to use")
    ...
    with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), "cosmos_reason1_job_multi_node.sh"), "r") as f:
        template = f.read()
