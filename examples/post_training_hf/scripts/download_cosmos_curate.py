...
"""Download cosmos-curate webdataset."""
...
def main():
    ...
    parser.add_argument("input", type=str, help="Input webdataset path.")
    parser.add_argument(
        "output", type=str, help="Output huggingface dataset path."
    )
    ...
    dataset = list(tqdm(map(process_sample, dataset), total=dataset_size, desc="Processing dataset"))
